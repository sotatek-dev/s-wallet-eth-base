...
export class EthGateway extends AccountBasedGateway {
  ...
  public async constructRawTransaction(
    ...
    const gasPrice = web3.utils.toBN(await web3.eth.getGasPrice());
    const gasLimit = web3.utils.toBN(isConsolidate ? 21000 : 150000); // Maximum gas allow for Ethereum transaction
    ...
    const tx = new EthereumTx({
      ...
      data: '',
      gasLimit: web3.utils.toHex(isConsolidate ? 21000 : 150000),
